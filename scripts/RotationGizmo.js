...
OSMEX.RotationGizmo.prototype.setTarget = function ( target ) {
    ...
    if ( target ) {
      ...
      //     console.log (angle*180/Math.PI);
        ...
        this.AxisY.rotationFunc = function(target) { return function(vector) { target.rotation.y += 2 } }(this.target);
        
        this.AxisZ.rotationFunc = function(target) { return function(vector) { target.rotation.z += 2 } }(this.target);
    }
    else {
